  ...
  Object.freeze({
    ...
    expectations: {
      paths: [
        ...
        { path: 'editp_carrier.weapondefs.dronecontroller.customparams.manualdrones', equals: 1 },
        { path: 'editp_carrier.weapondefs.dronecontroller.customparams.enabledocking', equals: 1 },
        { path: 'editp_carrier.weapondefs.dronecontroller.customparams.dockingpieces', equals: '1,1,1' },
