...
const editorAdvancedGroups = [
  ...
  },
  {
    ...
    params: [
      ...
      {
        key: 'turretspeedy',
        label: 'Turret Traverse Speed (Yaw)',
        path: 'customparams.turretspeedy',
        type: 'number',
        unit: 'deg/s',
        min: 10,
        max: 720,
        owner: 'BAR script convention',
        description: 'Horizontal turret traverse rate for unit scripts reading customparams.turretspeedy.',
      },
      {
        key: 'turretspeedx',
        label: 'Turret Elevation Speed (Pitch)',
        ...
        max: 720,
        owner: 'BAR script convention',
        description: 'Vertical barrel elevation rate for unit scripts reading customparams.turretspeedx.',
      },
  ...
  },
  {
    ...
    params: [
      ...
      { key: 'shieldforce', label: 'Repulse Force', type: 'number' },
      {
        ...
        label: 'Shield Radius',
        type: 'number',
        unitMirrorPath: 'customparams.shield_radius',
      },
      {
        key: 'shieldpower',
        label: 'Shield Capacity',
        type: 'number',
        unitMirrorPath: 'customparams.shield_power',
      },
