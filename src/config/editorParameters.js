const STAT_PRESENTATION = Object.freeze({
  ...
  workertime: { group: 'Economy', unit: 'work/s', alwaysRelevant: true },
  ...
  builddistance: { group: 'Economy', unit: 'elmos', alwaysRelevant: true },
  builder: { group: 'Economy', alwaysRelevant: true },
