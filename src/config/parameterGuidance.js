...
const PARAMETER_RELATIONSHIPS = [
  ...
  { section: 'weapons', title: 'Accuracy and leading', description: 'Spread, movement error, prediction, and firing tolerance jointly determine practical hit rate.', keys: ['accuracy', 'sprayangle', 'movingaccuracy', 'targetmoveerror', 'predictboost', 'leadlimit', 'leadbonus', 'tolerance', 'firetolerance', 'turretspeedy', 'turretspeedx'] },
...
const ADDITIONAL_PARAMETER_HELP = Object.freeze({
  ...
  turretspeedy: 'Horizontal turret traverse rate in degrees per second for unit scripts reading customparams.turretspeedy.',
  turretspeedx: 'Vertical barrel elevation rate in degrees per second for unit scripts reading customparams.turretspeedx.',
