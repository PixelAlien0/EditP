...
const PARAMETER_RELATIONSHIPS = [
  ...
  { section: 'weapons', title: 'Sector fire (horizontal spread)', description: 'BAR’s Tremor gadget rotates horizontal projectile velocity to scatter shots across a ground sector. Ordinary accuracy and spray still apply, so use the clean baseline when you want a readable horizontal pattern.', keys: ['speceffect', 'spread_angle', 'max_range_reduction', 'accuracy', 'sprayangle'] },
...
const PARAMETER_HELP = {
  ...
  speceffect: 'Select sector_fire to opt this WeaponDef into BAR’s verified Tremor-style sector-fire gadget. Reset returns to the inherited WeaponDef behavior.',
