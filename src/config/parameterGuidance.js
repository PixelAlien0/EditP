...
const PARAMETER_HELP = {
  ...
  'customparams.speceffect': 'BAR gadget-backed special effect mode. Valid inputs: "sector_fire" (Tremor-style horizontal ground sector), "area_damage" (persistent flame/gas ground hazard), "cluster_fire" (MIRV submunitions), "spawner" (impact unit creator).',
  'customparams.spread_angle': 'Total horizontal left/right spread angle in degrees across the ground sector (e.g. 22 for Tremor, 45 for a wide wall).',
  'customparams.max_range_reduction': 'Fraction (0.00 to 1.00) controlling depth variation toward the shooter within the sector (e.g. 0.30 for Tremor 30% depth).',
