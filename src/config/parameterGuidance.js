...
const PARAMETER_RELATIONSHIPS = [
  ...
  { section: 'weapons', title: 'Carrier deployment', description: 'Carrier payload, timing, capacity, costs, control range, and death behavior form one gadget-backed system.', keys: ['carried_unit', 'dronetype', 'spawnrate', 'maxunits', 'startingdronecount', 'spawn_metal_cost', 'spawn_energy_cost', 'controlradius', 'engagementrange', 'carrierdeaththroe'] },
...
const PARAMETER_HELP = {
  ...
  controlradius: 'Distance at which deployed units are recalled to the carrier; zero disables the limit.', engagementrange: 'Distance within which deployed units adopt the carrier’s active combat commands.',
