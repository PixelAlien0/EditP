              ...
              <div className="header-tools-menu" id="header-tools-menu" role="menu" aria-label="Editor tools">
                ...
                <div className="header-tools-menu__group" aria-label="Editing tools">
                  ...
                  <button type="button" role="menuitem" onClick={() => { setShowFormulaMutator(true); setShowToolsMenu(false); }}>
                    <span><strong>Formula Mutator <small style={{ color: '#ffb74d', fontFamily: 'monospace', fontWeight: 700 }}>[DEV]</small></strong><small>Evaluate math scaling equations</small></span>
                  </button>
                  <button type="button" role="menuitem" onClick={() => { setShowCarrierWorkbench(true); setShowToolsMenu(false); }}>
                    <span><strong>Carrier &amp; Drone Studio <small style={{ color: '#ffb74d', fontFamily: 'monospace', fontWeight: 700 }}>[DEV]</small></strong><small>Forge parent-child carrier hangars</small></span>
                  </button>
